...
const Hero = () => {
    ...
    return (
        <section className="h-[calc(80vh-87px)] pt-28 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 sm:gap-5 items-center">
            <aside className="flex flex-col justify-center">
                ...
                <div className="flex flex-row gap-6 justify-center sm:justify-start items-center mt-10">
                    <LinkButton
                        name="Github"
